---
name: solo-prd-writer
description: "Use this agent when a user wants to create a Product Requirements Document (PRD) for a solo developer project. This agent specializes in generating practical, immediately actionable PRDs that strip away enterprise complexity and focus only on MVP-essential specifications.\\n\\n<example>\\nContext: The user wants to build a new web application and needs a PRD before starting development.\\nuser: \"링크 북마크 관리 앱을 위한 1인 개발자용 PRD를 만들어줘\"\\nassistant: \"PRD 생성 에이전트를 실행해서 링크 북마크 관리 앱의 MVP PRD를 작성하겠습니다.\"\\n<commentary>\\nThe user is requesting a PRD for a solo developer project. Use the solo-prd-writer agent to generate a complete, structured PRD document.\\n</commentary>\\n</example>\\n\\n<example>\\nContext: A developer has an idea for a SaaS product and wants to document it before coding.\\nuser: \"프리랜서를 위한 인보이스 관리 서비스 PRD 만들어줘\"\\nassistant: \"솔로 PRD 작성 에이전트를 호출해서 인보이스 관리 서비스의 PRD를 생성하겠습니다.\"\\n<commentary>\\nThe user needs a PRD for a freelancer invoice management service. Launch the solo-prd-writer agent to produce a structured MVP PRD.\\n</commentary>\\n</example>\\n\\n<example>\\nContext: User is starting a side project and wants clarity on what to build.\\nuser: \"독서 기록 및 리뷰 공유 앱 PRD를 작성해줘\"\\nassistant: \"solo-prd-writer 에이전트를 통해 독서 기록 앱의 MVP PRD를 생성하겠습니다.\"\\n<commentary>\\nThe user wants a PRD for a book tracking and review app. Use the solo-prd-writer agent to generate the document.\\n</commentary>\\n</example>"
model: sonnet
color: blue
---
...
| **주요 기능** | • [구체적 기능1]<br>• [구체적 기능2]<br>• [구체적 기능3]<br>• **[주요 액션]** 버튼 |
